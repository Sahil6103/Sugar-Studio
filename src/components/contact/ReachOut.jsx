    ...
    <section ref={sectionRef} className="px-3 md:px-10 lg:px-20">
      <div className="content mb-12 lg:my-14 flex flex-col md:flex-row md:justify-between items-start lg:gap-24">
        <div className="heading flex items-start gap-3 mt-5 w-full md:w-1/2 lg:w-2/5">
          ...
          <h1 className="font-heading uppercase text-xl md:text-2xl flex tracking-wide ">
        ...
        <div className="w-full md:w-1/2 lg:w-3/5 flex flex-col md:flex-row md:justify-start md:items-start gap-6 lg:gap-14 xl:gap-28 my-5">
          <div className="flex flex-col ">
            <span
              ref={span1Ref}
              className="font-heading text-xs font-semibold tracking-wider text-[#000000]">
              Mobile / Whatsapp :
            </span>
            <p
              ref={detail1Ref}
          ...
          <div className="flex flex-col ">
            ...
            <div
              ref={detail3Ref}
              className="adress flex flex-col font-paragraph text-sm tracking-wide">
