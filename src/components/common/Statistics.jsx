...
export const Statistics = forwardRef(({ num, text }, ref) => {
  return (
    ...
    <div
      ref={ref}
      className="group relative flex justify-center items-center w-52 h-52">
      ...
      {/* Static Content */}
      <div className="flex flex-col justify-center items-center gap-2 w-48 h-48 bg-light-gray rounded-full">
        <span className="text-3xl font-heading tracking-wider">{num}</span>
